import type { Event, Projection } from '@interslavic/database-engine-eventstore';
import type { InMemoryProjectionStore } from '@interslavic/database-engine-eventstore-memory';
